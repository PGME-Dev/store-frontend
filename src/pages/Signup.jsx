        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="gradient-hero px-8 sm:px-10 pt-10 sm:pt-12 pb-8 sm:pb-10 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-5 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                <img src="/logo.png" alt="PGME" className="w-9 h-9 sm:w-10 sm:h-10 object-contain" />
              </div>
              <h1 className="font-display text-xl sm:text-2xl font-bold text-white mb-2">Create Your Account</h1>
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="space-y-4">
              <a
                ...
                className="btn-primary w-full !py-3.5 justify-center no-underline text-sm sm:text-base !text-white"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn-outline w-full !py-3.5 justify-center no-underline text-sm sm:text-base"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
