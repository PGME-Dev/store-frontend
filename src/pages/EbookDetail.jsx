      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col sm:flex-row gap-5 sm:gap-6 md:gap-8 mb-5 sm:mb-6">
              {book.thumbnail_url && (
              ...
              <div className="flex-1">
                <div className="bg-white rounded-2xl border border-border p-5 sm:p-6">
                  <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-text font-display mb-1">{book.title}</h1>
                  {book.author && <p className="text-sm text-text-secondary mb-4">by {book.author}</p>}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {book.pages && (
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-primary/6 rounded-xl flex items-center justify-center text-primary shrink-0">
                ...
                {book.ebook_file_format && (
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-accent/6 rounded-xl flex items-center justify-center text-accent shrink-0">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-success/6 rounded-xl flex items-center justify-center text-success shrink-0">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
